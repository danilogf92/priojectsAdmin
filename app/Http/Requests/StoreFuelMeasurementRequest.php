...
class StoreFuelMeasurementRequest extends FormRequest
{
  ...
  public function messages()
  {
    return [
      ...
      'kw_start_value.required' => 'The end value field is required.',

      'kw_end_value.numeric' => 'The kw end value must be a number.',
      'kw_end_value.required' => 'The end value field is required.',

      'kw_difference.numeric' => 'The kw difference must be a number.',
      'kw_difference.required' => 'The end value field is required.',

      'hour_start_value.numeric' => 'The hour start value must be a number.',
      'hour_start_value.required' => 'The end value field is required.',

      'hour_end_value.numeric' => 'The hour end value must be a number.',
      'hour_end_value.required' => 'The end value field is required.',

      'hour_difference.numeric' => 'The hour difference must be a number.',
      'hour_difference.required' => 'The end value field is required.',
