// components/project/CreateProjectForm.jsx
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    name="data_uploaded"
                    id="data_uploaded"
                    checked={data.data_uploaded || false} // Asegura que sea booleano
                    onChange={(e) => setData("data_uploaded", e.target.checked)} // Usar e.target.checked para booleanos
